...
SELECT EXPLAIN ANALYSE SELECT COUNT(*) FROM visits WHERE animal_id = 4;
SELECT EXPLAIN ANALYSE SELECT * FROM visits WHERE vets_id = 2;
SELECT EXPLAIN ANALYSE SELECT visits_id, animal_id, vets_id, date_of_visit FROM visits WHERE vets_id = 2;
SELECT EXPLAIN ANALYSE SELECT * FROM owners WHERE email = 'owner_18327@mail.com'